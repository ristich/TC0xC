...
static void CLI_Flag(CLI_Object *cli, uint8_t nargs, char **args)
{
    ...
    // unsigned long long crypt = 0x95a67dc088a865d3;
    // unsigned long long key = 0xFeca1ca7Feca1ca7;
    // char flag = (char)(crypt ^ key);
    // cli->serial->printf("flag{%s}\n");
    String flag = "byte_fu";
    cli->serial->print("flag{");
    cli->serial->print(flag);
    cli->serial->println("}");
}
